<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Brand.aspx.cs" Inherits="StockManagementSystems.Brand" %>
    ...
    font-size: medium;
        ...
        <table class="TableBody">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="cateList" runat="server" CssClass="textbox"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="brndName" runat="server" CssClass="textbox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <asp:GridView ID="grdvr" runat="server" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:BoundField DataField="category" HeaderText="User Category" />
